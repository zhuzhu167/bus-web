  ...
  <div class="bus-index fadeIn" v-show="is_mapLoad">
    ...
    <div class="place">
      <map
        class="map"
        id="map"
        :enable-traffic="RealTimeBus"
        :bindupdated="mapLoaded()"
        :enable-zoom="false"
        :markers="markers"
        :longitude="longitude"
        :latitude="latitude"
        scale="16"
        subkey="3ZCBZ-6NXRG-46HQX-I54ZE-BJ2O2-3JFIQ"
      ></map>
    </div>
    <div class="list">
    ...
    <div v-show="is_busSta" class="fadeInUp" :class=" is_up ? 'bus-msg-up' : 'bus-msg'">
      ...
      <div v-if="!is_up" class="down" @click="showStaMsg()">收起</div>
    </div>
  </div>
</template>
